        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.card}>
                ...
                <View style={styles.textView}>
                    ...
                    <MontText style={{ fontSize: 20, marginTop: 70, marginHorizontal: 10, color: "#FAFAFA", }}>{formData.cardNo == "" ? "0000 0000 0000 0000" : format(formData.cardNo)}</MontText>
            ...
            <View style={{ borderWidth: 1, borderColor: "#2A2A2A", borderRadius: 9, padding: 10, marginVertical: 10 }}>
                <TextInput maxLength={16} value={formData.cardNo} onChangeText={e => setFormData(prev => ({ ...prev, cardNo: e }))} style={{ fontFamily: "Mont" }} placeholder="0000 0000 0000 0000" />
            </View>
